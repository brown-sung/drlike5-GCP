...
// --- Gemini API 서비스 ---
async function callGemini(systemPrompt, context, model = 'gemini-2.0-flash-lite-001', isJson = false) {
...
const generateNextQuestion = async (history, extracted_data) => {
    ...
    return await callGemini(SYSTEM_PROMPT_GENERATE_QUESTION, context, 'gemini-2.0-flash-lite-001');
};
